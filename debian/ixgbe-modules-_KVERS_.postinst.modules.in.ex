#!/bin/sh
# postinst script for modules package built from ixgbe
...
case "$1" in
    configure)
        ...
        modprobe ixgbe-foo 2>/dev/null || modprobe ixgbe-bar 2>/dev/null || true
        # start or restart after install or upgrade
		# Tests to see if the binary exists first
        if test -x /usr/sbin/ixgbe ; then
		  invoke-rc.d ixgbe start || true
        fi
    ;;
